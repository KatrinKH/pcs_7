...
import 'package:pcs_7/model/note.dart'; // Импортируем модель
...
class ShoppingCartPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Вычисляем сумму всех товаров в корзине
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 15), // Отступ перед суммой
            Row(
              ...
              children: [
                ...
                Text(
                  '${totalSum.toStringAsFixed(2)} Р', // Форматируем сумму до двух знаков после запятой
